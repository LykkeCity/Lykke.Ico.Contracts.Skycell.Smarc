...
var SMARC = artifacts.require('./contracts/SMARC.sol')
...
contract('SMARC', function (accounts) {
    ...
    it('should deploy all the contracts', function () => {
    return SMARC.MiniMeTokenFactory.deployed().then(function(tokenFactory){
    return SMARC.MiniMeToken.deployed(web3,
      ...
      18,
      'MMT',
      true)}).then(function(miniMeToken){
    ...
    it("test ERC20 basic functionality", function () {
        return SMARC.deployed().then(function (instance) {
...
// CREATION
    ...
    it('creation: should create an initial balance of 0 for everyone', function () {
        SMARC.new({from: accounts[0]}).then(function (owner) {
...
// normal transfers without approvals.
    ...
    it('transfers: ether transfer should be reversed.', function () {
        var ctr
        return SMARC.new({from: accounts[0]}).then(function (result) {
                ctr = result
